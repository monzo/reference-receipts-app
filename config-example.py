...
# If your application runs on a server with client secret hidden from user, it should be registered as 
# confidential and will have the ability to refresh access tokens.
